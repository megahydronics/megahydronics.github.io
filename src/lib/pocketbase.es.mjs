        ...
        function ClientResponseError(t) {
            ...
            return (
                ...
                null !== t &&
                    ...
                    (s.isAbort = !!t.isAbort),
                    (s.originalError = t.originalError),
                    null !== t.response && 'object' == typeof t.response ? (s.response = t.response) : null !== t.data && 'object' == typeof t.data ? (s.response = t.data) : (s.response = {})),
                s.originalError || t instanceof ClientResponseError || (s.originalError = t),
                'undefined' != typeof DOMException && t instanceof DOMException && (s.isAbort = !0),
                (s.name = 'ClientResponseError ' + s.status),
                (s.message = null === (n = s.response) || void 0 === n ? void 0 : n.message),
                s.message ||
                    (s.isAbort
                        ? (s.message = 'The request was autocancelled. You can find more info in https://github.com/pocketbase/js-sdk#auto-cancellation.')
                        : (
                              null === (r = null === (o = null === (i = s.originalError) || void 0 === i ? void 0 : i.cause) || void 0 === o ? void 0 : o.message) || void 0 === r
                                  ? void 0
                                  : r.includes('ECONNREFUSED ::1')
                          )
                        ? (s.message = 'Failed to connect to the PocketBase server. Try changing the SDK URL from localhost to 127.0.0.1 (https://github.com/pocketbase/js-sdk/issues/21).')
                        : (s.message = 'Something went wrong while processing your request.')),
                s
            )
        }
        return (
...
function cookieSerialize(e, t, i) {
    ...
    if ((o.httpOnly && (a += '; HttpOnly'), o.secure && (a += '; Secure'), o.priority))
...
e =
    'function' == typeof atob
        ...
        : function (e) {
              ...
              for (var n, i, o = 0, r = 0, s = ''; (i = t.charAt(r++)); ~i && ((n = o % 4 ? 64 * n + i : i), o++ % 4) ? (s += String.fromCharCode(255 & (n >> ((-2 * o) & 6)))) : 0)
...
var i = (function () {
        ...
        return (
            ...
            (Record.prototype.load = function (t) {
                e.prototype.load.call(this, t),
                    (this.collectionId = 'string' == typeof t.collectionId ? t.collectionId : ''),
                    (this.collectionName = 'string' == typeof t.collectionName ? t.collectionName : ''),
                    this._loadExpand(t.expand)
            }),
    ...
    a = (function () {
        ...
        return (
            ...
            (BaseAuthStore.prototype.exportToCookie = function (e, t) {
                var n, i, r
                void 0 === t && (t = s)
                var a = { secure: !0, sameSite: !0, httpOnly: !0, path: '/' },
                ...
                return (
                    u.model &&
                        ...
                        this.model instanceof o && ((u.model.username = this.model.username), (u.model.verified = this.model.verified), (u.model.collectionId = this.model.collectionId)),
                        (l = cookieSerialize(t, JSON.stringify(u), e))),
                    l
                )
            }),
        ...
        return (
            ...
            Object.defineProperty(LocalAuthStore.prototype, 'model', {
                get: function () {
                    ...
                    return null === t || 'object' != typeof t || null === t.model || 'object' != typeof t.model
                        ? null
                        : void 0 === (null === (e = t.model) || void 0 === e ? void 0 : e.collectionId)
                        ? new r(t.model)
                        : new o(t.model)
                },
                enumerable: !1,
            ...
            (LocalAuthStore.prototype._storageRemove = function (e) {
                var t
                'undefined' != typeof window && (null === window || void 0 === window ? void 0 : window.localStorage) && (null === (t = window.localStorage) || void 0 === t || t.removeItem(e)),
    ...
    l = (function (e) {
        ...
        return (
            ...
            (SettingsService.prototype.getAll = function (e) {
                return (
                    void 0 === e && (e = {}),
                    this.client.send('/api/settings', { method: 'GET', params: e }).then(function (e) {
                        return e || {}
                    })
                )
            }),
            (SettingsService.prototype.update = function (e, t) {
                return (
                    void 0 === e && (e = {}),
                    void 0 === t && (t = {}),
                    this.client.send('/api/settings', { method: 'PATCH', params: t, body: e }).then(function (e) {
                        return e || {}
                    })
                )
            }),
            ...
            (SettingsService.prototype.generateAppleClientSecret = function (e, t, n, i, o, r, s) {
                return (
                    void 0 === r && (r = {}),
                    void 0 === s && (s = {}),
                    (r = Object.assign({ clientId: e, teamId: t, keyId: n, privateKey: i, duration: o }, r)),
                    this.client.send('/api/settings/apple/generate-client-secret', { method: 'POST', params: s, body: r })
                )
            }),
            SettingsService
        )
    })(u),
    d = function d(e, t, n, i, o) {
            ...
            return (
                        ...
                        request = function (r) {
                            return __awaiter(i, void 0, void 0, function () {
                                return __generator(this, function (i) {
                                    return [
                                        2,
                                        this._getList(e, r, t || 500, n).then(function (e) {
                                            var t = e.items
                ...
                (BaseCrudService.prototype._getList = function (e, t, n, i) {
                    ...
                    return (
                        ...
                        this.client.send(e, { method: 'GET', params: i }).then(function (e) {
                            var t = []
                ...
                (BaseCrudService.prototype._getOne = function (e, t, n) {
                    ...
                    return (
                        void 0 === n && (n = {}),
                        this.client.send(e + '/' + encodeURIComponent(t), { method: 'GET', params: n }).then(function (e) {
                            return i.decode(e)
                        })
                    )
                }),
                (BaseCrudService.prototype._getFirstListItem = function (e, n, i) {
                    return (
                        void 0 === i && (i = {}),
                        (i = Object.assign({ filter: n, skipTotal: 1, cancelKey: 'one_by_filter_' + e + '_' + n }, i)),
                        this._getList(e, 1, 1, i).then(function (e) {
                            var n
                            if (!(null === (n = null == e ? void 0 : e.items) || void 0 === n ? void 0 : n.length))
                ...
                (BaseCrudService.prototype._create = function (e, t, n) {
                    ...
                    return (
                        void 0 === t && (t = {}),
                        void 0 === n && (n = {}),
                        this.client.send(e, { method: 'POST', params: n, body: t }).then(function (e) {
                            return i.decode(e)
                        })
                    )
                }),
                (BaseCrudService.prototype._update = function (e, t, n, i) {
                    ...
                    return (
                        void 0 === n && (n = {}),
                        void 0 === i && (i = {}),
                        this.client.send(e + '/' + encodeURIComponent(t), { method: 'PATCH', params: i, body: n }).then(function (e) {
                            return o.decode(e)
                        })
                    )
                }),
                (BaseCrudService.prototype._delete = function (e, t, n) {
                    return (
                        void 0 === n && (n = {}),
                        this.client.send(e + '/' + encodeURIComponent(t), { method: 'DELETE', params: n }).then(function () {
                            return !0
                        })
                    )
                }),
    ...
    p = (function (e) {
        ...
        return (
                    ...
                    e.prototype.update.call(this, t, n, i).then(function (e) {
                        ...
                        return (
                            o.client.authStore.model &&
                                void 0 === (null === (t = o.client.authStore.model) || void 0 === t ? void 0 : t.collectionId) &&
                                (null === (n = o.client.authStore.model) || void 0 === n ? void 0 : n.id) === (null == e ? void 0 : e.id) &&
                    ...
                    e.prototype.delete.call(this, t, n).then(function (e) {
                        ...
                        return (
                            e &&
                                ...
                                void 0 === (null === (n = i.client.authStore.model) || void 0 === n ? void 0 : n.collectionId) &&
                                (null === (o = i.client.authStore.model) || void 0 === o ? void 0 : o.id) === t &&
            ...
            (AdminService.prototype.authResponse = function (e) {
                ...
                return (
                    (null == e ? void 0 : e.token) && (null == e ? void 0 : e.admin) && this.client.authStore.save(e.token, t),
                    Object.assign({}, e, { token: (null == e ? void 0 : e.token) || '', admin: t })
                )
            }),
            (AdminService.prototype.authWithPassword = function (e, t, n, i) {
                return (
                    ...
                    this.client.send(this.baseCrudPath + '/auth-with-password', { method: 'POST', params: i, body: n }).then(this.authResponse.bind(this))
                )
            }),
            (AdminService.prototype.authRefresh = function (e, t) {
                return (
                    void 0 === e && (e = {}), void 0 === t && (t = {}), this.client.send(this.baseCrudPath + '/auth-refresh', { method: 'POST', params: t, body: e }).then(this.authResponse.bind(this))
                )
            }),
            (AdminService.prototype.requestPasswordReset = function (e, t, n) {
                return (
                    ...
                    this.client.send(this.baseCrudPath + '/request-password-reset', { method: 'POST', params: n, body: t }).then(function () {
                        return !0
                    })
                )
            }),
            (AdminService.prototype.confirmPasswordReset = function (e, t, n, i, o) {
                return (
                    void 0 === i && (i = {}),
                    void 0 === o && (o = {}),
                    (i = Object.assign({ token: e, password: t, passwordConfirm: n }, i)),
                    this.client.send(this.baseCrudPath + '/confirm-password-reset', { method: 'POST', params: o, body: i }).then(function () {
                        return !0
                    })
                )
            }),
        ...
        return (
            ...
            (ExternalAuth.prototype.load = function (t) {
                e.prototype.load.call(this, t),
                    ...
                    (this.providerId = 'string' == typeof t.providerId ? t.providerId : '')
            }),
            ExternalAuth
        )
    })(i),
    f = (function (e) {
        ...
        return (
                ...
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (n) {
                        return (
                            ...
                            [2, this.client.realtime.subscribe(this.collectionIdOrName + '/' + e, t)]
                        )
                    })
                })
            }),
                    ...
                    return __generator(this, function (i) {
                        if ('function' == typeof e)
                            return (
                                ...
                                [2, this.client.realtime.subscribe(this.collectionIdOrName, e)]
                            )
                ...
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (t) {
                        return '*' === e
                            ...
                            : e
                            ? [2, this.client.realtime.unsubscribe(this.collectionIdOrName + '/' + e)]
                            : [2, this.client.realtime.unsubscribeByPrefix(this.collectionIdOrName)]
                    })
                })
            }),
            ...
            (RecordService.prototype.update = function (t, n, i) {
                ...
                return (
                    ...
                    e.prototype.update.call(this, t, n, i).then(function (e) {
                        var t, n, i
                        return (
                            (null === (t = o.client.authStore.model) || void 0 === t ? void 0 : t.id) !== (null == e ? void 0 : e.id) ||
                                ((null === (n = o.client.authStore.model) || void 0 === n ? void 0 : n.collectionId) !== o.collectionIdOrName &&
                                    (null === (i = o.client.authStore.model) || void 0 === i ? void 0 : i.collectionName) !== o.collectionIdOrName) ||
                                o.client.authStore.save(o.client.authStore.token, e),
                            e
                        )
                    })
            ...
            (RecordService.prototype.delete = function (t, n) {
                ...
                return (
                    ...
                    e.prototype.delete.call(this, t, n).then(function (e) {
                        ...
                        return (
                            !e ||
                                (null === (n = i.client.authStore.model) || void 0 === n ? void 0 : n.id) !== t ||
                                ((null === (o = i.client.authStore.model) || void 0 === o ? void 0 : o.collectionId) !== i.collectionIdOrName &&
                                    (null === (r = i.client.authStore.model) || void 0 === r ? void 0 : r.collectionName) !== i.collectionIdOrName) ||
                                i.client.authStore.clear(),
                            e
                        )
                    })
            ...
            (RecordService.prototype.authResponse = function (e) {
                ...
                return this.client.authStore.save(null == e ? void 0 : e.token, t), Object.assign({}, e, { token: (null == e ? void 0 : e.token) || '', record: t })
            }),
            (RecordService.prototype.listAuthMethods = function (e) {
                return (
                    void 0 === e && (e = {}),
                    this.client.send(this.baseCollectionPath + '/auth-methods', { method: 'GET', params: e }).then(function (e) {
            ...
            (RecordService.prototype.authWithPassword = function (e, t, n, i) {
                ...
                return (
                    ...
                    void 0 === i && (i = {}),
                    (n = Object.assign({ identity: e, password: t }, n)),
                    this.client.send(this.baseCollectionPath + '/auth-with-password', { method: 'POST', params: i, body: n }).then(function (e) {
            ...
            (RecordService.prototype.authWithOAuth2Code = function (e, t, n, i, o, r, s) {
                ...
                return (
                    ...
                    void 0 === r && (r = {}),
                    void 0 === s && (s = {}),
                    (r = Object.assign({ provider: e, code: t, codeVerifier: n, redirectUrl: i, createData: o }, r)),
                    this.client.send(this.baseCollectionPath + '/auth-with-oauth2', { method: 'POST', params: s, body: r }).then(function (e) {
            ...
            (RecordService.prototype.authWithOAuth2 = function () {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (a) {
                        switch (a.label) {
                            case 0:
                                return e.length > 1 || 'string' == typeof (null == e ? void 0 : e[0])
                                    ? (console.warn(
                                    ...
                                    : ((n = (null == e ? void 0 : e[0]) || {}), [4, this.listAuthMethods()])
                            case 1:
                                if (
                                    ((i = a.sent()),
                                    !(o = i.authProviders.find(function (e) {
                                        return e.name === n.provider
                                    })))
                                )
                                    throw new t(new Error('Missing or invalid provider "'.concat(n.provider, '".')))
                                return (
                                    (r = this.client.buildUrl('/api/oauth2-redirect')),
                                    [
                                        2,
                                                ...
                                                return __generator(this, function (h) {
                                                    switch (h.label) {
                                                        ...
                                                        case 1:
                                                            return (
                                                                (s = h.sent()),
                                                                (a = { state: this.client.realtime.clientId }),
                                                                (null === (l = n.scopes) || void 0 === l ? void 0 : l.length) && (a.scope = n.scopes.join(' ')),
                                                                (c = this._replaceQueryParams(o.authUrl + r, a)),
                                                                [4, n.urlCallback ? n.urlCallback(c) : this._defaultUrlCallback(c)]
                                                            )
                                                        case 2:
                                                            return h.sent(), [3, 4]
                                                        case 3:
            ...
            (RecordService.prototype.authRefresh = function (e, t) {
                ...
                return (
                    void 0 === e && (e = {}),
                    void 0 === t && (t = {}),
                    this.client.send(this.baseCollectionPath + '/auth-refresh', { method: 'POST', params: t, body: e }).then(function (e) {
            ...
            (RecordService.prototype.requestPasswordReset = function (e, t, n) {
                return (
                    ...
                    void 0 === n && (n = {}),
                    (t = Object.assign({ email: e }, t)),
                    this.client.send(this.baseCollectionPath + '/request-password-reset', { method: 'POST', params: n, body: t }).then(function () {
                        return !0
                    })
                )
            }),
            (RecordService.prototype.confirmPasswordReset = function (e, t, n, i, o) {
                return (
                    ...
                    void 0 === o && (o = {}),
                    (i = Object.assign({ token: e, password: t, passwordConfirm: n }, i)),
                    this.client.send(this.baseCollectionPath + '/confirm-password-reset', { method: 'POST', params: o, body: i }).then(function () {
                        return !0
                    })
                )
            }),
            (RecordService.prototype.requestVerification = function (e, t, n) {
                return (
                    ...
                    void 0 === n && (n = {}),
                    (t = Object.assign({ email: e }, t)),
                    this.client.send(this.baseCollectionPath + '/request-verification', { method: 'POST', params: n, body: t }).then(function () {
                        return !0
                    })
                )
            }),
            (RecordService.prototype.confirmVerification = function (e, t, n) {
                return (
                    ...
                    this.client.send(this.baseCollectionPath + '/confirm-verification', { method: 'POST', params: n, body: t }).then(function () {
                        return !0
                    })
                )
            }),
            (RecordService.prototype.requestEmailChange = function (e, t, n) {
                return (
                    ...
                    this.client.send(this.baseCollectionPath + '/request-email-change', { method: 'POST', params: n, body: t }).then(function () {
                        return !0
                    })
                )
            }),
            (RecordService.prototype.confirmEmailChange = function (e, t, n, i) {
                return (
                    ...
                    this.client.send(this.baseCollectionPath + '/confirm-email-change', { method: 'POST', params: i, body: n }).then(function () {
                        return !0
                    })
                )
            }),
            (RecordService.prototype.listExternalAuths = function (e, t) {
                return (
                    void 0 === t && (t = {}),
                    this.client.send(this.baseCrudPath + '/' + encodeURIComponent(e) + '/external-auths', { method: 'GET', params: t }).then(function (e) {
                        var t = []
                        if (Array.isArray(e))
            ...
            (RecordService.prototype.unlinkExternalAuth = function (e, t, n) {
                return (
                    void 0 === n && (n = {}),
                    this.client.send(this.baseCrudPath + '/' + encodeURIComponent(e) + '/external-auths/' + encodeURIComponent(t), { method: 'DELETE', params: n }).then(function () {
                        return !0
                    })
                )
            }),
    ...
    m = function m(e) {
        void 0 === e && (e = {}),
            ...
            (this.options = 'object' == typeof e.options && null !== e.options ? e.options : {})
    },
    b = (function (e) {
        function Collection() {
            return (null !== e && e.apply(this, arguments)) || this
        ...
        return (
            ...
            (Collection.prototype.load = function (t) {
                e.prototype.load.call(this, t),
                    ...
                    (this.options = void 0 !== t.options && null !== t.options ? t.options : {}),
                    (this.indexes = Array.isArray(t.indexes) ? t.indexes : []),
                    (this.listRule = 'string' == typeof t.listRule ? t.listRule : null),
                    (this.viewRule = 'string' == typeof t.viewRule ? t.viewRule : null),
                    (this.createRule = 'string' == typeof t.createRule ? t.createRule : null),
                    (this.updateRule = 'string' == typeof t.updateRule ? t.updateRule : null),
                    (this.deleteRule = 'string' == typeof t.deleteRule ? t.deleteRule : null),
                ...
                return (
                    ...
                    __awaiter(this, void 0, void 0, function () {
                        return __generator(this, function (i) {
                            return [
                                2,
                                this.client.send(this.baseCrudPath + '/import', { method: 'PUT', params: n, body: { collections: e, deleteMissing: t } }).then(function () {
                                    return !0
                                })
                            ]
                        })
        ...
        return (
            ...
            (LogRequest.prototype.load = function (t) {
                e.prototype.load.call(this, t),
                    ...
                    (this.userAgent = 'string' == typeof t.userAgent ? t.userAgent : ''),
        ...
        return (
            ...
            (LogService.prototype.getRequestsList = function (e, t, n) {
                return (
                    ...
                    this.client.send('/api/logs/requests', { method: 'GET', params: n }).then(function (e) {
                        var t = []
                        if (null == e ? void 0 : e.items) {
            ...
            (LogService.prototype.getRequest = function (e, t) {
                return (
                    void 0 === t && (t = {}),
                    this.client.send('/api/logs/requests/' + encodeURIComponent(e), { method: 'GET', params: t }).then(function (e) {
                        return new g(e)
                    })
                )
            }),
            (LogService.prototype.getRequestsStats = function (e) {
                return (
                    void 0 === e && (e = {}),
                    this.client.send('/api/logs/requests/stats', { method: 'GET', params: e }).then(function (e) {
                        return e
                    })
                )
            }),
    ...
    w = (function (e) {
        function RealtimeService() {
            ...
            return (
                ...
                (t.predefinedReconnectIntervals = [200, 300, 500, 1e3, 1200, 1500, 2e3]),
                (t.pendingConnects = []),
                t
            )
        }
        return (
                    ...
                    return __generator(this, function (r) {
                        switch (r.label) {
                            case 0:
                                ...
                                for (i = !1, o = this.subscriptions[e].length - 1; o >= 0; o--)
                                    this.subscriptions[e][o] === t &&
                                        ((i = !0), delete this.subscriptions[e][o], this.subscriptions[e].splice(o, 1), null === (n = this.eventSource) || void 0 === n || n.removeEventListener(e, t))
            ...
            (RealtimeService.prototype.addAllSubscriptionListeners = function () {
                if (this.eventSource)
                    for (var e in (this.removeAllSubscriptionListeners(), this.subscriptions))
            ...
            (RealtimeService.prototype.disconnect = function (e) {
                ...
                if (
                    ...
                    null === (t = this.eventSource) || void 0 === t || t.close(),
    ...
    _ = (function (e) {
        ...
        return (
            __extends(FileService, e),
            (FileService.prototype.getUrl = function (e, t, n) {
                void 0 === n && (n = {})
                var i = []
            ...
            (FileService.prototype.getToken = function (e) {
                return (
                    void 0 === e && (e = {}),
                    this.client.send('/api/files/token', { method: 'POST', params: e }).then(function (e) {
    ...
    R = (function (e) {
        ...
        return (
            __extends(BackupService, e),
            (BackupService.prototype.getFullList = function (e) {
            ...
            (BackupService.prototype.delete = function (e, t) {
                return (
                    void 0 === t && (t = {}),
                    this.client.send('/api/backups/'.concat(encodeURIComponent(e)), { method: 'DELETE', params: t }).then(function () {
                        return !0
                    })
                )
            }),
            (BackupService.prototype.restore = function (e, t) {
                return (
                    void 0 === t && (t = {}),
                    this.client.send('/api/backups/'.concat(encodeURIComponent(e), '/restore'), { method: 'POST', params: t }).then(function () {
                        return !0
                    })
                )
            }),
    ...
    O = (function () {
        function Client(e, t, n) {
            void 0 === e && (e = '/'),
                ...
                (this.files = new _(this)),
                (this.logs = new S(this)),
                (this.settings = new l(this)),
                (this.realtime = new w(this)),
                (this.health = new C(this)),
                (this.backups = new R(this))
        }
        return (
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (w) {
                        switch (w.label) {
                            case 0:
                                return (
                                    (d = Object.assign({ method: 'GET' }, n)),
                                    this.isFormData(d.body) ||
                                        (d.body && 'string' != typeof d.body && (d.body = JSON.stringify(d.body)),
                                        void 0 === (null === (i = null == d ? void 0 : d.headers) || void 0 === i ? void 0 : i['Content-Type']) &&
                                            (d.headers = Object.assign({}, d.headers, { 'Content-Type': 'application/json' }))),
                                    void 0 === (null === (o = null == d ? void 0 : d.headers) || void 0 === o ? void 0 : o['Accept-Language']) &&
                                        (d.headers = Object.assign({}, d.headers, { 'Accept-Language': this.lang })),
                                    (null === (r = this.authStore) || void 0 === r ? void 0 : r.token) &&
                                        void 0 === (null === (s = null == d ? void 0 : d.headers) || void 0 === s ? void 0 : s.Authorization) &&
                                        (d.headers = Object.assign({}, d.headers, { Authorization: this.authStore.token })),
                                    this.enableAutoCancellation &&
                                        !1 !== (null === (a = d.params) || void 0 === a ? void 0 : a.autoCancel) &&
                                        ((h = (null === (c = d.params) || void 0 === c ? void 0 : c.cancelKey) || (d.method || 'GET') + e),
                                    ...
                                    (v = this.buildUrl(e)),
                                    void 0 !== d.params && ((f = this.serializeQueryParams(d.params)) && (v += (v.includes('?') ? '&' : '?') + f), delete d.params),
                                    this.beforeSend ? ((y = (b = Object).assign), (g = [{}]), [4, this.beforeSend(v, d)]) : [3, 2]
                                )
                            case 1:
                                void 0 !== (m = y.apply(b, g.concat([w.sent()]))).url || void 0 !== m.options
                                    ? ((v = m.url || v), (d = m.options || d))
                                    : Object.keys(m).length &&
                                      ((d = m),
                                      (null === console || void 0 === console ? void 0 : console.warn) &&
            ...
            (Client.prototype.buildUrl = function (e) {
                ...
                return (
                    'undefined' == typeof window ||
                        ...
                        n.startsWith('https://') ||
                        n.startsWith('http://') ||
                        ((n = (null === (t = window.location.origin) || void 0 === t ? void 0 : t.endsWith('/'))
                            ? window.location.origin.substring(0, window.location.origin.length - 1)
                            : window.location.origin || ''),
                        this.baseUrl.startsWith('/') || ((n += window.location.pathname || '/'), (n += n.endsWith('/') ? '' : '/')),
                        (n += this.baseUrl)),
                    e && ((n += n.endsWith('/') ? '' : '/'), (n += e.startsWith('/') ? e.substring(1) : e)),
                    n
                )
            }),
