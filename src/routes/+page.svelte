<script>
    ...
    import Tile from '$lib/com/Tile.svelte'
                ...
                <div class="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                    <div class="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                        ...
                        <div class="mt-8 flex items-center gap-x-4">
                            ...
                            <a data-label="actions.1" href={data.pages[data.actions[1].destination].path} class="text-sm whitespace-pre px-2 py-1 font-semibold leading-6 text-gray-900"
                                >{data.actions[1].title}</a>
                        </div>
                    </div>
