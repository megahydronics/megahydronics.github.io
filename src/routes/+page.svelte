            ...
            <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
                ...
                <div class="mt-6 flex flex-col gap-x-8 gap-y-20 lg:flex-row">
                    ...
                    >
                        ...
                        <p class="mt-8">
                            Our goal is for our full range of services to earn the highest praise
                            for honesty and integrity in all aspects of project delivery from
                            evaluation through completion. Over years of combined experience our
                            mission has been to deliver top tier services to our multi-family,
                            commercial and industrial clients addressing heating, air conditioning,
